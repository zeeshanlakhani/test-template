...
The main way to get help is by sending an email to [zeeshan@foo.com][support-email].
...
need to be the best programmer to contribute. Our discord is open for questions
 ...
 6. **Build** the project
    - For a detailed look on how to build aproject look at our
